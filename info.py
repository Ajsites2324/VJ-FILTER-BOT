...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002440632621 -1002352964508').split()]  # For Multiple Id Use One Space Between Each.
